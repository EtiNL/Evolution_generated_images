...
class DQN_CNN(nn.Module):
    def __init__(self, input_shape, output_dim):
        ...
        self.conv4 = nn.Conv2d(64, 128, kernel_size=4, stride=0)
        ...
        conv_w_4 = conv2d_size_out(conv2d_size_out(conv2d_size_out(conv2d_size_out(input_shape[1], 32, 4), 16, 2), 8, 1), 4, 0)
        conv_h_4 = conv2d_size_out(conv2d_size_out(conv2d_size_out(conv2d_size_out(input_shape[2], 32, 4), 16, 2), 8, 1), 4, 0)
